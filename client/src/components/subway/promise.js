          ...
          <li className="grid_li_item">
            <div id="grid_1st" className="grid_box">
              ...
              <div className="grid_txt_area">
                ...
                <div>
                  <span className="grid_head_txt">
                    엄격하게 관리되는 우리의 재료
                  </span>
                  <p className="grid_main_txt">
                    매일 매장에 배송되는 신선한 야채들은 각 매장에서 정성스럽게
                    손질됩니다.
                    <br />
            ...
            <div id="grid_2nd" className="grid_box">
              ...
              <div className="grid_txt_area">
                ...
                <div>
                  ...
                  <p className="grid_main_txt">
                    1983년부터 써브웨이는 각 매장에서 매일 직접 구워 낸 <br />
                    신선한 샌드위치 빵을 제공합니다.
                    <br />
              ...
              <div className="grid_txt_area">
                ...
                <div>
                  ...
                  <p className="grid_main_txt">
                    ...
                    <br />
                    환경을 늘 생각하는 브랜드가 되기 위해 지속적으로 노력하고
                    있습니다.
                  </p>
                </div>
              </div>
