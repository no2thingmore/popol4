  ...
  return(
    <div className="subwayfranchise">
          ...
          <ul id="brandcomp_ul">
            <li id="brandcomp_li">
              ...
              <ul className="band_comp_ul">
                ...
                <li>· 글로벌 브랜드 관리 및 지원 - 신제품 개발, 브랜드<br></br>&nbsp;&nbsp;&nbsp;가치 향상, 스탠더드 관리</li>
              </ul>
            </li>
            <li id="brandcomp_li">
              <div className="jun_brandcomp_img1">
      ...
      <div className="franchise_process">
        <h2>가맹점 개설 절차</h2>
        <p>높은 수익성과 탁월한 안정성이 전세계 104개국, 37,525여개 매장으로 검증된 글로벌 No.1 프랜차이즈 써브웨이</p>
        <p>체계화된 성공 노하우와 함께 새로운 비즈니스의 시작을 준비하십시오.</p>
        <p id="process_p">※ 가맹 신청부터 매장 오픈까지 최소 2달 이상 소요됩니다.</p>
          ...
          <div className="c_back1">
            ...
            <div className="c_table_1">
              <table>
                ...
                <tbody>
                  ...
                  <tr>
                    <td>장비 및 기자재</td>
                    <td>12,000만원</td>
                    <td>샌드위치 유니트, 브래드 오븐, 스피드 오븐, 전자레인지, 냉장냉동시설, <br></br>
                    주방설비 및 집기, 커피머신, CCTV, 음향장비, 가구 및 인테리어 소품 등</td>
                  </tr>
                  <tr>
                    <td>인테리어<br></br>
                        (간판 및 철거비용 제외)
              ...
              <div className="last_ppp">
                <p>※ 일반 매장 최소 전용면적은 25평이며, 공항, 백화점, 병원 등 특수상권 매장은 25평 이하로 선택적 입점 가능</p>
