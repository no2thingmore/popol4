        ...
        <div className="faq_container2">
          <div className="faq_section">
            <div className="faq_section_title" onClick={() => toggleSection("sec2")}>
              <div><i class="fa-solid fa-q"></i>&nbsp;&nbsp;&nbsp;&nbsp; 써브웨이 가맹점주가 되기 위한 조건이 있나요?</div>
            ...
            <div className={sections.sec2 ? "faq-section-content-visible" : "faq-section-content-hidden"}>      
              {sections.sec2 && 
                <div id="first_list">
                  <p><i class="fa-solid fa-a"></i></p>
                  <p id="second_list">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  써브웨이는 50년이 넘는 역사를 지닌 프랜차이즈이며, 전 세계 가장 많은 매장을 운영하는 글로벌 QSR 브랜드 입니다.<br></br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  따라서 제품의 퀄리티, 매장 운영, 고객 서비스에 있어 브랜드의 가치를 실현하기 위해 운영 매누얼 및 본사의 규정과 지침을<br></br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  이행하고 준수할 수 있는 분, 고객 서비스 마인드를 갖춘 분과 가맹계약을 체결합니다.<br></br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
