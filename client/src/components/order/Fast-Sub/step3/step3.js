    ...
    <div className="CHM_step3Bg">
      {datacount === 0 ? (
        <div style={{ textAlign: "center" }}>
          <img src={sand} width="25%"></img>
          <div
            style={{ textAlign: "center", fontSize: "2vw", paddingTop: "1vw" }}
          >
            상품 정보가 없습니다...
          </div>
          <div
            className="CHM_faststep2ResultCart"
            style={{ columnGap: "1.5vw", paddingTop: "3vw" }}
          >
            <Link to="/">
            ...
            <Link to={`/order/Fast-Sub/step2/${replacedString}/0/Nan`}>
              <div className="CHM_faststep2ResultCartBtn3">
                상품 추가하기 <i class="fa-solid fa-plus"></i>
              </div>
            </Link>
          </div>
        </div>
                ...
                <div key={i}>
                  <div className="CHM_step3CartContentGrid">
                    <div className="CHM_step3CartContentname">
                      <span
                        style={{ paddingRight: "1.5vw", fontSize: "1.4vw" }}
                      >
                        {cartItem[0].mainName}
                      </span>
                    </div>
